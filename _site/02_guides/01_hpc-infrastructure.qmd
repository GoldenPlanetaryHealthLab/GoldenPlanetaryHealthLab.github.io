...
and SSH. OOD is a web-based interface that provides access to interactive 
apps like RStudio Server, Jupyter, and Matlab, as well as file browsing and 
job submission tools. SSH is a command-line interface that allows you to 
connect to the cluster from your terminal and use the command line to run 
commands, manage files, and submit jobs.
